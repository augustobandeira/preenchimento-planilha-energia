...
with st.sidebar:
    ...
    st.markdown(
        ...
        "medição. A ferramenta calcula a data de cada dia a partir da data "
        "já cadastrada na aba **1** e cola os dados na aba certa, limpando "
        "qualquer resíduo de preenchimentos antigos."
    )
    with st.expander("Detalhes técnicos"):
        st.markdown(
            "- Só escreve nas colunas **A:M** das abas numeradas.\n"
            "- Nunca toca em fórmulas — Resumo e M1-M7 recalculam sozinhos "
            "quando você abre o arquivo no Excel.\n"
